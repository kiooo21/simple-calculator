  ...
  Widget build(BuildContext context) {
    var calc = SimpleCalculator(
      ...
      theme: const CalculatorThemeData(
        ...
        borderWidth: 2,
        displayColor: Color.fromARGB(255, 250, 245, 245),
        displayStyle: TextStyle(fontSize: 80, color: Colors.black),
        expressionColor: Color.fromARGB(255, 0, 0, 0),
        expressionStyle: TextStyle(fontSize: 20, color: Colors.white),
        operatorColor: Color.fromARGB(255, 240, 108, 152),
        operatorStyle: TextStyle(fontSize: 30, color: Colors.white),
        commandColor: Color.fromARGB(255, 255, 198, 112),
